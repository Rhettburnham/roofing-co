...
def main():
    ...
    # Input files - use rawroofing_till30097.csv as an example
    leads_file = os.path.join(data_dir, "rawroofing_till30097.csv")
    bbb_profiles_file = os.path.join(data_dir, "bbb_profile_data.json")
