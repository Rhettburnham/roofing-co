...
const deriveInitialLocalData = (bookingDataInput) => {
  ...
  return {
    ...
    showNailAnimation: variantSpecificData.showNailAnimation !== undefined ? variantSpecificData.showNailAnimation : true,
...
=============================================== */
const BookingPreview = memo(({ bookingData, readOnly, onBookingDataChange, socialIconLocation }) => {
  ...
  const toggleFormVisibility = useCallback(() => {
    console.log('Book Now button clicked - isMobile:', isMobile, 'isAnimating:', isAnimating, 'readOnly:', readOnly, 'isFormVisible:', isFormVisible);
    
    if (!isMobile || isAnimating || readOnly) return;
    
    // Check if the form container ref exists
    if (!formContainerRef.current) {
      console.warn("Form container ref not found, cannot toggle form visibility");
      return;
    }
        ...
        <div ref={contentRef} className="relative z-20">
          <div className="relative py-3 px-4 flex flex-col items-center z-30">
            <div className="flex items-center justify-center w-full">
              <img src={getLogoDisplayUrl(logo)} alt="logo" className="w-20 h-20 mr-4 drop-shadow-[0_1.2px_1.2px_rgba(255,30,0,0.8)]" style={{ filter: "invert(1)" }}/>
              <div className="text-left drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)]" style={{color: currentHeaderTextColor}}>
                {!readOnly ? (
                  ...
                  <h2 className="text-2xl md:text-3xl font-bold" style={{color: currentHeaderTextColor}}>
                    {headerText}
                  </h2>
                )}
                ...
                {!readOnly ? (
                  ...
                  <p className="font-bold md:text-lg mt-1" style={{color: currentHeaderTextColor}}>
                    {phone}
                  </p>
                )}
              </div>
            ...
            {socialLinks && socialLinks.length > 0 && (!readOnly || socialIconLocation === "above") && (
            ...
            {isMobile && (
              ...
              >
                {isFormVisible ? <div className="relative z-40 flex space-x-1 justify-center"><div className="w-2 h-2 rounded-full bg-black"></div><div className="w-2 h-2 rounded-full bg-black"></div><div className="w-2 h-2 rounded-full bg-black"></div></div> : <span className="relative z-40 text-md font-semibold">BOOK NOW</span>}
              </button>
            )}
          </div>
          ...
          <div
            ...
            style={{
              ...
              transform: readOnly ? 'scale(1)' : (isMobile && !isFormVisible ? 'scale(0.95)' : 'scale(1)'),
              visibility: readOnly ? 'visible' : (isMobile && !isFormVisible ? 'hidden' : 'visible'),
              pointerEvents: readOnly ? 'auto' : (isMobile && !isFormVisible ? 'none' : 'auto'),
            }}
          >
            {socialLinks && socialLinks.length > 0 && (!readOnly || socialIconLocation === "below") && (
            ...
            <div className="rounded-lg p-3 shadow-inner mx-2 mt-2" style={{backgroundColor: currentFormBgColor}}>
              ...
              <div className="mb-4 text-center">
                {!readOnly ? (
                  ...
                  <h3 className="text-lg md:text-xl font-semibold text-center" style={{color: currentInputTextColor}}>
                    {bookingData.formTitle}
                  </h3>
                ) : null}
              </div>
...
=============================================== */
const ModernBookingVariant = memo(({ bookingData, readOnly, onBookingDataChange, socialIconLocation }) => {
  ...
  const handleServiceOptionsChange = useCallback((newOptions) => {
  ...
  const removeServiceOption = useCallback((index) => {
    const serviceOptions = bookingData?.serviceOptions || [];
    const newOptions = serviceOptions.filter((_, i) => i !== index);
    handleServiceOptionsChange(newOptions);
  }, [bookingData?.serviceOptions, handleServiceOptionsChange]);

  const updateServiceOption = useCallback((index, value) => {
    const serviceOptions = bookingData?.serviceOptions || [];
  ...
  if (!headerText && !formTitle) {
    return <div className="p-8 text-center text-gray-500">Modern variant data not configured</div>;
  }
  ...
  const gradientStart = colors.modernGradientStart || colors.gradientStart || '#1e293b';
  const gradientEnd = colors.modernGradientEnd || colors.gradientEnd || '#334155';

  return (
    <div className="w-full max-w-6xl mx-auto px-4 py-8">
      <div className="bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 rounded-3xl shadow-2xl overflow-hidden relative" style={{
        background: `linear-gradient(to bottom right, ${gradientStart}, ${primaryBgColor})`
      }}>
        
        <div className="grid lg:grid-cols-2 gap-0">
          {/* Left Side - Contact Info */}
          <div className="bg-gradient-to-br from-blue-600 to-purple-700 p-8 lg:p-12 flex flex-col justify-center text-white relative overflow-hidden" style={{
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col items-center lg:items-start mb-8">
                ...
                <div className="text-center lg:text-left">
                  {!readOnly ? (
                    ...
                    <h1 className="text-4xl lg:text-5xl font-light mb-4 leading-tight" style={{color: primaryTextColor}}>
                      {headerText}
                    </h1>
                  )}
                  ...
                  {!readOnly ? (
                    ...
                    <p className="text-xl lg:text-2xl font-medium" style={{color: primaryTextColor}}>
                      {phone}
                    </p>
                  )}
                </div>
              ...
              <div className="space-y-6">
                {features.map((feature, index) => (
                  <div key={feature.id || index} className="flex items-center space-x-4 relative">
                    {!readOnly && (
                      <button
                    ...
                    <div className="flex-1">
                      {!readOnly ? (
                        ...
                        <>
                          <h3 className="font-semibold text-lg" style={{color: primaryTextColor}}>
                            {feature.title}
                          </h3>
                          <p style={{color: primaryTextColor, opacity: 0.8}}>
                            {feature.subtitle}
                          </p>
                        </>
                      )}
                ...
                {!readOnly && (
                  ...
                  >
                    ...
                    <div className="text-left">
                      ...
                      <p className="opacity-80 text-xs">Click to add a new feature</p>
                    </div>
                  </button>
                )}
              </div>
          ...
          {/* Right Side - Form */}
          <div className="p-8 lg:p-12" style={{backgroundColor: cardBgColor}}>
            {/* Form Title - variant specific */}
            {!readOnly ? (
              <input
                type="text"
              ...
              <h2 className="text-3xl lg:text-4xl font-light mb-8" style={{color: secondaryTextColor}}>
                {formTitle}
              </h2>
            )}
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label className="text-sm font-medium" style={{color: secondaryTextColor}}>First Name</label>
                  <input
                    type="text"
                    name="firstName"
                    value={formData.firstName}
                    onChange={handleChange}
                    placeholder={formFields.firstNamePlaceholder || "Enter your first name"}
                    required
                    disabled={readOnly}
                  ...
                  {!readOnly && (
                    <input
                      ...
                      onChange={(e) => handleFormFieldChange('firstNamePlaceholder', e.target.value)}
                ...
                <div className="space-y-2">
                  <label className="text-sm font-medium" style={{color: secondaryTextColor}}>Last Name</label>
                  <input
                    type="text"
                    name="lastName"
                    value={formData.lastName}
                    onChange={handleChange}
                    placeholder={formFields.lastNamePlaceholder || "Enter your last name"}
                    required
                    disabled={readOnly}
                    className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all focus:bg-white"
                    style={{backgroundColor: inputBgColor, color: inputTextColor}}
                  ...
                  {!readOnly && (
                    <input
                      ...
                      onChange={(e) => handleFormFieldChange('lastNamePlaceholder', e.target.value)}
                      className="w-full text-xs bg-gray-100 px-2 py-1 rounded border outline-none"
                      placeholder="Edit placeholder text"
                    />
                  )}
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium" style={{color: secondaryTextColor}}>Email</label>
                <input
                  type="email"
                  name="email"
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium" style={{color: secondaryTextColor}}>Phone</label>
                <input
                  type="tel"
                  name="phone"
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium" style={{color: secondaryTextColor}}>Service Needed</label>
                <select
                  name="service"
                  ...
                  style={{backgroundColor: inputBgColor, color: inputTextColor}}
                >
                  <option value="">{formFields.servicePlaceholder || "Select a service"}</option>
                ...
                {!readOnly && (
                  <div className="space-y-2">
                    <input
                      ...
                      onChange={(e) => handleFormFieldChange('servicePlaceholder', e.target.value)}
                      className="w-full text-xs bg-gray-100 px-2 py-1 rounded border outline-none"
                      placeholder="Edit select placeholder"
                    />
                    <div className="text-xs" style={{color: secondaryTextColor}}>Service Options:</div>
                    {serviceOptions.map((option, index) => (
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium" style={{color: secondaryTextColor}}>Message</label>
                <textarea
                  name="message"
                  value={formData.message}
                  onChange={handleChange}
                  placeholder={formFields.messagePlaceholder || "Tell us about your project..."}
                  required
                  disabled={readOnly}
                  rows="4"
              ...
              <div className="space-y-2">
                ...
                >
                  {isSubmitting ? (formFields.submittingText || "Sending...") : (formFields.submitButtonText || "Get Free Quote")}
                </button>
                {!readOnly && (
                  <div className="grid grid-cols-2 gap-2">
                    <input
                      ...
                      onChange={(e) => handleFormFieldChange('submitButtonText', e.target.value)}
                    ...
                    <input
                      ...
                      onChange={(e) => handleFormFieldChange('submittingText', e.target.value)}
                      className="text-xs bg-gray-100 px-2 py-1 rounded border outline-none"
...
=============================================== */
const CreativeBookingVariant = memo(({ bookingData, readOnly, onBookingDataChange, socialIconLocation }) => {
  // All hooks must be called at the top, before any conditional logic
  const [formData, setFormData] = useState({ firstName: "", lastName: "", email: "", phone: "", service: "", message: "" });
  const [isSubmitting, setIsSubmitting] = useState(false);
  ...
  const handleBadgeChange = useCallback((index, field, value) => {
  ...
  const handleGalleryImageChange = useCallback((index, field, value) => {
  ...
  const removeBadge = useCallback((index) => {
    const badges = bookingData?.badges || [];
  ...
  // Don't render if no essential data is available
  if (!headerText && !formTitle) {
    return <div className="p-8 text-center text-gray-500">Creative variant data not configured</div>;
  }
  ...
  const inputTextColor = colors.inputText || '#374151';
  const cardBgColor = colors.cardBackground || '#FFFFFF';
  const gradientStart = colors.creativeGradientStart || colors.gradientStart || '#4c1d95';
  const gradientEnd = colors.creativeGradientEnd || colors.gradientEnd || '#be185d';
  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 py-8">
      <div className="bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-800 rounded-3xl shadow-2xl overflow-hidden relative" style={{
        background: `linear-gradient(to bottom right, ${gradientStart}, ${gradientEnd})`
      }}>
            ...
            <div className="flex flex-col items-center mb-8">
              ...
              <div className="text-center max-w-2xl">
                ...
                {!readOnly ? (
                  ...
                  <p className="text-2xl md:text-3xl font-bold mb-4" style={{color: primaryTextColor}}>
                    {phone}
                  </p>
                )}
              </div>
            ...
            <div className="lg:col-span-1">
              ...
              <div className="grid grid-cols-1 gap-4 mb-8">
                {displayBadges.map((badge, index) => (
                  <div key={badge.id || index} className="bg-gradient-to-r from-white/20 to-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-6 relative hover:transform hover:scale-105 transition-all duration-300">
                    {!readOnly && (
                      <button
              ...
              {(galleryImages.length > 0 || !readOnly) && (
                <div>
                  <h3 className="text-2xl font-bold text-white mb-6 text-center">Our Work</h3>
              ...
              <div className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl p-8 border border-white/20">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      <input
                        ...
                        value={formData.firstName}
                        onChange={handleChange}
                        placeholder={formFields.firstNamePlaceholder || "First Name"}
                        required
                        disabled={readOnly}
                    ...
                    <div className="space-y-2">
                      <input
                        ...
                        value={formData.lastName}
                        onChange={handleChange}
                        placeholder={formFields.lastNamePlaceholder || "Last Name"}
                        required
                        disabled={readOnly}
                        className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-purple-400 focus:outline-none transition-colors bg-white/90 placeholder-gray-500"
                      />
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      <option value="">{formFields.servicePlaceholder || "🏠 Select Service"}</option>
                      {serviceOptions.map((option, index) => (
                        <option key={index} value={option}>{option}</option>
                      ))}
                    </select>
...
const BookingImagesControls = ({ currentData, onControlsChange, themeColors }) => {
  ...
  const addSocialLink = () => {
    onControlsChange({ ...currentData, socialLinks: [...(currentData.socialLinks || []), { platform: "twitter", url: "" }] });
  };

  const removeSocialLink = (index) => {
    onControlsChange({ ...currentData, socialLinks: (currentData.socialLinks || []).filter((_, i) => i !== index) });
  };
...
const BookingColorControls = ({ currentData, onControlsChange, themeColors }) => {
    ...
    <div className="p-4 space-y-4">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <ThemeColorPicker 
          ...
          onColorChange={(fieldName, value) => handleColorUpdate('primaryBackground', value)}
        ...
        <ThemeColorPicker 
          ...
          themeColors={themeColors} 
          onColorChange={(fieldName, value) => handleColorUpdate('secondaryBackground', value)}
        ...
        <ThemeColorPicker 
          ...
          themeColors={themeColors} 
          onColorChange={(fieldName, value) => handleColorUpdate('primaryText', value)}
        ...
        <ThemeColorPicker 
          ...
          themeColors={themeColors} 
          onColorChange={(fieldName, value) => handleColorUpdate('secondaryText', value)}
        ...
        <ThemeColorPicker 
          ...
          themeColors={themeColors} 
          onColorChange={(fieldName, value) => handleColorUpdate('accentText', value)}
        ...
        <ThemeColorPicker 
          ...
          themeColors={themeColors} 
          onColorChange={(fieldName, value) => handleColorUpdate('buttonBackground', value)}
        ...
        <ThemeColorPicker 
          ...
          themeColors={themeColors} 
          onColorChange={(fieldName, value) => handleColorUpdate('buttonText', value)}
        ...
        <ThemeColorPicker 
          ...
          themeColors={themeColors} 
          onColorChange={(fieldName, value) => handleColorUpdate('inputBackground', value)}
        ...
        <ThemeColorPicker 
          ...
          themeColors={themeColors} 
          onColorChange={(fieldName, value) => handleColorUpdate('inputText', value)}
          fieldName="inputText"
        />
        <ThemeColorPicker 
          ...
          themeColors={themeColors} 
          onColorChange={(fieldName, value) => handleColorUpdate('cardBackground', value)}
        ...
        <ThemeColorPicker 
          ...
          themeColors={themeColors} 
          onColorChange={(fieldName, value) => handleColorUpdate('gradientStart', value)}
        ...
        <ThemeColorPicker 
          ...
          themeColors={themeColors} 
          onColorChange={(fieldName, value) => handleColorUpdate('gradientEnd', value)}
      ...
      {currentVariant === 'modern' && (
        <div className="mt-6 pt-4 border-t border-gray-200">
          <h3 className="text-sm font-semibold text-gray-700 mb-3">Modern Variant Colors</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <ThemeColorPicker 
              label="Modern Gradient Start:"
              currentColorValue={currentColors.modernGradientStart || '#1e293b'} 
              themeColors={themeColors} 
              onColorChange={(fieldName, value) => handleColorUpdate('modernGradientStart', value)}
            ...
            <ThemeColorPicker 
              ...
              themeColors={themeColors} 
              onColorChange={(fieldName, value) => handleColorUpdate('modernGradientEnd', value)}
            ...
            <ThemeColorPicker 
              ...
              themeColors={themeColors} 
              onColorChange={(fieldName, value) => handleColorUpdate('modernAccentStart', value)}
            ...
            <ThemeColorPicker 
              ...
              themeColors={themeColors} 
              onColorChange={(fieldName, value) => handleColorUpdate('modernAccentEnd', value)}
      ...
      {currentVariant === 'creative' && (
        <div className="mt-6 pt-4 border-t border-gray-200">
          <h3 className="text-sm font-semibold text-gray-700 mb-3">Creative Variant Colors</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <ThemeColorPicker 
              label="Creative Gradient Start:"
              currentColorValue={currentColors.creativeGradientStart || '#4c1d95'} 
              themeColors={themeColors} 
              onColorChange={(fieldName, value) => handleColorUpdate('creativeGradientStart', value)}
            ...
            <ThemeColorPicker 
              ...
              themeColors={themeColors} 
              onColorChange={(fieldName, value) => handleColorUpdate('creativeGradientEnd', value)}
              fieldName="creativeGradientEnd"
            />
            <ThemeColorPicker 
              label="Creative Header Gradient:"
              currentColorValue={currentColors.creativeHeaderGradient || '#fbbf24'} 
              themeColors={themeColors} 
              onColorChange={(fieldName, value) => handleColorUpdate('creativeHeaderGradient', value)}
              fieldName="creativeHeaderGradient"
            />
            <ThemeColorPicker 
              label="Creative Sub Header Color:"
              currentColorValue={currentColors.creativeSubHeaderColor || '#fed7aa'} 
              themeColors={themeColors} 
              onColorChange={(fieldName, value) => handleColorUpdate('creativeSubHeaderColor', value)}
              fieldName="creativeSubHeaderColor"
            />
            <ThemeColorPicker 
              label="Creative Badge Gradient Start:"
              currentColorValue={currentColors.creativeBadgeGradientStart || '#fbbf24'} 
              themeColors={themeColors} 
              onColorChange={(fieldName, value) => handleColorUpdate('creativeBadgeGradientStart', value)}
              fieldName="creativeBadgeGradientStart"
            />
            <ThemeColorPicker 
              label="Creative Badge Gradient End:"
              currentColorValue={currentColors.creativeBadgeGradientEnd || '#f59e0b'} 
              themeColors={themeColors} 
              onColorChange={(fieldName, value) => handleColorUpdate('creativeBadgeGradientEnd', value)}
      ...
      <div className="mt-6 pt-4 border-t border-gray-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <ThemeColorPicker 
            ...
            themeColors={themeColors} 
            onColorChange={(fieldName, value) => handleColorUpdate('successColor', value)}
          ...
          <ThemeColorPicker 
            ...
            themeColors={themeColors} 
            onColorChange={(fieldName, value) => handleColorUpdate('errorColor', value)}
          ...
          <ThemeColorPicker 
            ...
            themeColors={themeColors} 
            onColorChange={(fieldName, value) => handleColorUpdate('warningColor', value)}
          ...
          <ThemeColorPicker 
            ...
            themeColors={themeColors} 
            onColorChange={(fieldName, value) => handleColorUpdate('infoColor', value)}
            fieldName="infoColor"
          />
        </div>
      </div>
    ...
    <div className="p-4 space-y-6">
      <div>
        ...
        <select
          ...
          onChange={e => onControlsChange({ ...currentData, socialIconLocation: e.target.value })}
...
export default function BookingBlock({
  ...
  const [localData, setLocalData] = useState(() => deriveInitialLocalData(bookingData));
...
BookingBlock.tabsConfig = (currentData, onControlsChange, themeColors, sitePalette) => {
  const tabs = {};
